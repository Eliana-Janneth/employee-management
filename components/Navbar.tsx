                        ...
                        >
                            <a href="#" className="flex items-center p-3 -mt-2 text-sm transition-colors duration-300 transform hover:bg-[#e74c4c] ">
                                ...
                                <div className="mx-1">
                                    ...
                                    <p className="text-sm">janedoe@exampl.com</p>
                                </div>
                            </a>
                            ...
                            <a href="#" className="block px-4 py-3 text-sm capitalize transition-colors duration-300 transform hover:bg-[#e74c4c]">Sign Out</a>
                        </div>
                    )}
                </div>
            </div>
