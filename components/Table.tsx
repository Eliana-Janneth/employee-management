        ...
        <section className="container px-4 mx-auto">
            <div className="flex items-center justify-between" >
                <div className="flex gap-x-3">
                    <h2 className="text-lg font-medium text-gray-800 ">Cantidad de Empleados</h2>
                    <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">{data.length}</span>
                </div>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60">
                                                    ...
                                                    <h2 className="text-sm font-normal text-emerald-500">{item.salary}</h2>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                <div className="flex items-center gap-x-2">
                                                    <p className="px-3 py-1 text-xs text-blue-500 rounded-full bg-blue-100/60">{item.date}</p>
                                                </div>
                                            </td>
                                            <td className="px-4 py-4 text-sm whitespace-nowrap">
